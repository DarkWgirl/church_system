...
$get_announcement = mysqli_query($web_db, "SELECT * from announcement_tbl where announcement_id = '$aid'");
    ...
    <div class="col-md-6 px-0">
      ...
      <p class="lead my-3">seek and you will find; knock and the door will be opened to you.</p>
            ...
            while($row = mysqli_fetch_array($get_announcement)){   
                $fromDate = date('F d, Y', strtotime($row['announcement_date']));
          ?>
         <div class="col-4">
                          <h3 class="text-white"><?php echo $row['announcement_title']; ?></h3>
                          <p class="fst-italic text-white">Type: <?php echo $row['announcement_type']; ?></p>
            <p class="fst-italic text-white"><?php echo $row['announcment_description']; ?></p>
              <p class="fst-italic text-white">Date: <?php echo $fromDate; ?></p>
          ...
          <img src="assets/aImage/<?php echo $row['announcement_image']; ?>" width="500">
        </div>
    </div>
