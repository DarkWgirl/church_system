...
$get_finance = mysqli_query($web_db, "SELECT * from donation_tbl INNER JOIN finance_tbl on finance_tbl.finance_id = donation_tbl.finance_id where donation_status = 'PENDING' AND finance_type = '$type'");
