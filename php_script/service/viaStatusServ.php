...
$get_pending_service = mysqli_query($web_db, "SELECT * from service_tbl INNER JOIN user_tbl on user_tbl.user_id = service_tbl.user_id where service_status = '$status'");
